...
<body bgcolor="lightgreen">
        ...
        <tr>
          ...
          <td><input type="text" name="pan" /></td>
       	...
       	<tr>
				...
				<tr class="visa-field1 hidden">
					<td><label>Passport Expiration Date</label></td>
       	...
       	<tr>
				...
				<tr class="visa-field hidden">
					<td><label for="visa-expiration">Visa Expiration Date</label></td>
 ...
 <tr>
       ...
       <br/>
       <a href="/personaldetails1">Previous</a>
